            ...
            <a href="/Dashboard" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"  style="color:rgb(242, 156, 43);font-weight:bold;"><i class="fas fa-arrow-left"></i> &nbsp; Back</a>
              ...
              <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="card">
                                <div class="card-body">
                                        <form method="POST" action="/adddebtor">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                    <label for="exampleFormControlInput1">Fee Description</label>
                                                    <input type="text" name="feename" class="form-control" id="exampleFormControlInput1" placeholder="EXample Tution fee and TCU Quality Assurance" required>
                                                   <!-- <select class="form-control" id="exampleFormControlSelect1" name="feename">
                                                            <option>TCU Quality Assurance</option>
                                                            <option selected>Tution Fee</option>
                                                            <option>Medical fee</option>
                                                            <option>Accomodation</option>
                                                            <option>Examination of Coursework</option>
                                                            <option>Examination of Dissertati</option>
                                                            <option>Destruction Penalty</option>
                                                            <option>Sport and Games Fees</option>
