...
<div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-6">
                <h1 class="h3 mb-0 text-gray-800" style="font-weight:400;color:gray;font-size:23px;letter-spacing:5px;">Verify Library Debts</h1>
              ...
              <div class="row">
                    ...
                    <div class="col-md-9">
                                    <div class="jumbotron">
                                        ...
                                        <p  class="lead" style="color:brown;"><strong>Your are Required To Pay, Total {{ $row->amount }} for Library {{ $row->feename }}</strong></p>
                                        <hr class="my-4">
                                        <p>If You arleady pay please verify Your Payments</p>
                                        <a class="btn btn-primary dark" href="/Verifylib" role="button">Verify Now!</a>
                                        @endforeach
