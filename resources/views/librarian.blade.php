...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-6">
            <h1 class="h3 mb-0 text-gray-800" style="font-weight:400;color:gray;font-size:23px;letter-spacing:5px;">ADD LIBRARIAN</h1>
                <a href="/Library" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="color:rgb(242, 156, 43);font-weight:bold;"><i class="fas fa-arrow-left"></i>&nbsp; View Users</a>
        </div>
        @csrf
        @if(session('success'))
        ...
        <div class="row">
                        ...
                        <div class="card-body">
                                <form method="POST" action="/Librarian">
                                    ...
                                    <!-- <div class="form-group">-->
                                                ...
                                                <input type="hidden" class="form-control" id="exampleFormControlSelect1" value="librarian" name="user_type" readonly>
                                              <!--</div>-->
                                    <div class="form-group">
            ...
            <div class="col-md-3 content-center">
                                ...
                                <img src="images/logo2.jpg" height="300px" width="280px;">
